...
def execute(cmd):
    ...
    print("execute cmd: %s returns decoded: %s" % (cmd, decoded))
    return decoded

# home rolled NetCat implementation
class NetCat:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Example: 
            ...
            netcat.py -t 192.168.1.108 -p 5555 -l -u=test_upload.txt # command shell

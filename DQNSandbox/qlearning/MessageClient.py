...
# stomp is a python messaging pub-sub library - pip install it
import stomp
...
class MyListener(stomp.ConnectionListener):
    ...
    def on_message(self, headers, body):
        ...
        # SessionProcessor(conn).runSessions(body, self)
        SessionProcessor(conn).runSessions(mockJSON(), self)
...
conn.send(body=registerMessage, headers={"DocumentType": "de.amirrocker.training.BasicServiceBundle"},
          destination="training-service-register-topic")

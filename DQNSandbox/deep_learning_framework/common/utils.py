...
class SMAQueue:
    '''
    Queue of fixed size with mean, min, max operations
    '''
    ...
    def __str__(self):
        return "SMAQueue(size=%d, lwn=%d)" % (self.size, len(self.queue))
...
class SpeedMonitor:
    ...
    def seconds(self):
        '''
        seconds since last reset has been called
        :return:
        '''
    ...
    def samples_per_second(self):
        ...
        :return: dloat count samples per second or None if not started
        '''
